...
public class ButtonAction : MonoBehaviour
{
    ...
    public Button nextButton, wallSelect, troopSelect, bombSelect, spawnerSelect, shooterSelect, tankSelect;
    public GameObject wall, troop, bomb, spawner, shooter, tank;
    ...
    void Start()
    {
        ...
        tankSelect.onClick.AddListener(SelectTank);
    }
    void NextLine()
    {
        Debug.Log("HELLO");
    ...
    {
        objectSelected = tank;
        objectSelectedCost = TroopMovement.cost;
    }
}
